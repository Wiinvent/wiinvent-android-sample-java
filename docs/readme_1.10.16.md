...
Old adSize BannerDisplayAdSize.LARGE_BANNER and BannerDisplayAdSize.MEDIUM_BANNER are deprecated
...
| adSize      | BannerDisplayAdSize.SUBPAGE_BANNER (display banner for subpage) <br/> BannerAdSize.HOMEPAGE_BANNER (display banner for homepage) <br/> BannerAdSize.PAUSE_BANNER (overlay banner) |
